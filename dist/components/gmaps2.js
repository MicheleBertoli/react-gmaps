...
var Gmaps = (function (_React$Component) {
	...
	_createClass(Gmaps, [{
		...
		key: 'mapsCallback',
		value: function mapsCallback() {
			this.createMap();
			this.addListeners(this.state.map, _eventsMap2['default']);
		}
	}, {
		key: 'createMap',
		value: function createMap() {
			var node = _reactDom2['default'].findDOMNode(this);
			map = new google.maps.Map(node, _extends({}, this.props, {
				center: new google.maps.LatLng(this.props.lat, this.props.lng)
			}));
			this.setState({ map: map, isMapCreated: true });
